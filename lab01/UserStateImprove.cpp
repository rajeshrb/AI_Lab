...
{
	UserState* ustemp=new UserState;
	for(int i=0; i<DIMENTION; i++)
	{
...
void UserState::Print_Path(UserState* goal_state,int count)
{	
	if(goal_state==NULL)
	{
		//~ cout<<count<<endl;
	...
	{
		Print_Path(goal_state->parent_state,count+1);
